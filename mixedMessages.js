...
let randomNumber = Math.floor(Math.random() * wisdom.length);


let randomQuote = wisdom[randomNumber].quote + "\n" + wisdom[randomNumber].author;

document.getElementById("txtbox") .value=randomQuote;}